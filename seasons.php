				...
				<div class="col">
					<div class="home_content">
						<div class="home_content_inner">
							<div class="home_title">Special Seasons</div>
							<div class="home_breadcrumbs">
								<ul class="home_breadcrumbs_list">
									<li class="home_breadcrumb"><a href="index.php">Home</a></li>
									<li class="home_breadcrumb">Special Seasons</li>
								</ul>
							</div>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-12">
					...
					<div class="mid2">
									  ...
									  <ul id="myUL">
									  	<li align="left"><a><b>Special Seasons</b></br></br>
										
										The Andaman and Nicobar Islands are one of the most popular beach tourist destinations for travellers. Winter, summer and monsoon are the main seasons here. Situated in the Bay of Bengal, the islands experience a tropical climate and heavy winds during monsoon.</br></br>
										<img src="images/seasons.jpg" height=500		width=100%></br></br>

Winters:  Winters start in December and end in February. However, unlike most of the mainland, temperatures still remain above 20 degrees throughout. The average minimum temperature remains around 22 degrees, while the average maximum reaches around 30 degrees making daytime a bit warm.</br></br></br>


Summers:  Beginning in March and lasting till mid-May, the average minimum temperature remains around 24 degrees while the maximum temperature can reach somewhere around 37 degrees.</br></br></br>

Monsoons:  The monsoon usually hits Andaman around late May and lasts until mid September. This is probably the least-recommended time to visit the islands. Strong winds, frequent rain and low visibility underwater are common during this season.</br></br></br>

Early November until mid-May sees the best weather, and often the best diving conditions in Andaman. The days are mostly sunny at this time of year, and the sea is sometimes flat enough to reflect the clouds above. Go2andaman recommends this season for travel.</br></br></br></br>
